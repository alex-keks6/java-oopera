...
public class Theatre {
    public static void main(String[] args) {
        ...
        Actor actor2 = new Actor("Пётр", "Иванов", Gender.MALE, 160);
        ...
        Person choreographer = new Person("Мигель", "Плавнов", Gender.MALE);
        Person musicAuthor = new Person("Варвара", "Музыкалова", Gender.FEMALE);
        ...
        // заменяем actor2 на actor1
        opera.replaceActorBySurname(actor1, "Иванов");
        opera.printListOfActors();
